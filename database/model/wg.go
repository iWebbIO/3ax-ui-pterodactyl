...
type WgServer struct {
	...
	// that redirect wg0 ingress to a loopback Xray inbound tagged
	...
	XrayInboundTag string `json:"xrayInboundTag" gorm:"default:'wg-tproxy-in'"`
	XrayTproxyPort int    `json:"xrayTproxyPort" gorm:"default:12346"`
