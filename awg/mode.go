...
// disk and awg-quick reads it.
var lastConf sync.Map // interfaceName(string) -> config(string)

// userspaceMode reports whether AmneziaWG runs through the in-process userspace
// engine (no root/TUN) instead of awg-quick. Driven by XUI_WG_MODE=userspace.
